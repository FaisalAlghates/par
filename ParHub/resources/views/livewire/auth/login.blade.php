        ...
        <div class="glass-effect rounded-3xl p-8 elegant-shadow">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-slate-900 dark:text-white mb-2">
                    Welcome to <span class="gradient-text">DocuMagic AI</span>
                </h1>
            ...
            <!-- Login Form -->
            <form wire:submit="login" class="space-y-6" onsubmit="console.log('Form submitted');">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" wire:navigate class="text-sm text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 transition-colors">
                                Forgot password?
                            </a>
                        @endif
                    </div>
            ...
            @if (Route::has('register'))
                <div class="mt-8 pt-6 border-t border-slate-200 dark:border-slate-700 text-center">
                    ...
                    <a href="{{ route('register') }}" wire:navigate class="w-full px-6 py-3 glass-effect rounded-xl hover:bg-white/20 transition-all duration-300 text-slate-700 dark:text-slate-300 font-medium inline-block">
                        Create New Account
                    </a>
