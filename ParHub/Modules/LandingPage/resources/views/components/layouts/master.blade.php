...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" 
    ...
    <head>
        ...
        <title>{{ config('app.name', 'DocuMagic AI') }}</title>

        <meta name="description" content="{{ $description ?? 'Transform your documents into stunning AI-powered presentations with DocuMagic AI' }}">
        <meta name="keywords" content="{{ $keywords ?? 'AI, presentations, documents, PDF, Word, PowerPoint, automation, artificial intelligence' }}">
